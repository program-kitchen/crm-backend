...
return [
    ...
    */
    ...
    'between'              => [
        ...
        'string'  => ':min文字以上:max文字以内で入力してください。',
    ...
    |--------------------------------------------------------------------------
    |
    | 独自のvalidationはここに定義する
    */
    'pass_invalid'  => '無効な文字が含まれています。',
    'pass_length'   => '8文字以上15文字以内で入力してください。',
    'pass_format'   => '半角英字、半角数字、記号を1つ以上含めてください。',
